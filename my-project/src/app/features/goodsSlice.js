...
const goodsSlice = createSlice({
    ...
    reducers:{
        ...
        editGood:(state,action)=>{
            state.goods[action.payload.indexObj]= action.payload.obj;
        },
        deleteGood:(state,action)=>{
            state.goods = state.goods.filter((g)=>state.goods.indexOf(g) !== action.payload)
        },
...
export const  {addGood,editGood,deleteGood} = goodsSlice.actions;
